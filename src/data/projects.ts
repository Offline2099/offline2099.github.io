...
export const PROJECTS: ProjectData[] = [
  ...
  },
  {
    ...
    numberOfImages: 8,
    description: {
      summary: 'A mini-game based on the classic Snake game. The player controls a snake that moves around and must collect food while avoiding obstacles or enemies.',
      features: [
